...
--
-- Host: db
-- Generation Time: Sty 23, 2025 at 01:20 PM
...
--
-- Zrzut danych tabeli `authorization_log`
--

INSERT INTO `authorization_log` (`id`, `user_id`, `username`, `type`, `user_type`, `time`, `user_ip`, `proxy_ip`, `browser`) VALUES
(1, 1, 'administrator@testarena.pl', 1, 2, '2025-01-23 13:50:47', '172.18.0.1', '', 'Not known '),
(2, 1, 'administrator@testarena.pl', 1, 2, '2025-01-23 13:56:30', '172.18.0.1', '', 'Not known '),
(3, 1, 'administrator@testarena.pl', 1, 2, '2025-01-23 14:01:58', '172.18.0.1', '', 'Not known ');
...
CREATE TABLE `defect_environment` (
  ...
  `type` enum('reported','resolved') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'reported'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `defect_version` (
  ...
  `type` enum('resolved','reported') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'reported'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Zrzut danych tabeli `environment`
--

INSERT INTO `environment` (`id`, `project_id`, `name`, `description`) VALUES
(1, 1, 'TP_Local', '');
...
CREATE TABLE `project` (
  ...
  `reopen_status_color` varchar(7) COLLATE utf8_unicode_ci NOT NULL,
  `closed_status_color` varchar(7) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `project` (`id`, `prefix`, `status`, `create_date`, `name`, `description`, `open_status_color`, `in_progress_status_color`, `reopen_status_color`, `closed_status_color`, `invalid_status_color`, `resolved_status_color`) VALUES
(1, 'TP', 1, '2025-01-23 14:13:27', 'TestProject', '', '#1d76f6', '#f6a000', '#9d2af6', '#993300', '#0082FE', '#8DD00E');
...
--
-- Zrzut danych tabeli `project_bug_tracker`
--

INSERT INTO `project_bug_tracker` (`id`, `project_id`, `bug_tracker_id`, `name`, `bug_tracker_type`, `bug_tracker_status`) VALUES
(1, 1, NULL, 'INTERNAL', 1, 2);
...
--
-- Zrzut danych tabeli `release`
--

INSERT INTO `release` (`id`, `project_id`, `start_date`, `end_date`, `name`, `description`, `active`) VALUES
(1, 1, '2025-01-23', '2025-01-26', 'TP_0.1', '', 1);
...
--
-- Zrzut danych tabeli `resolution`
--

INSERT INTO `resolution` (`id`, `project_id`, `name`, `color`, `description`) VALUES
(1, 1, 'Powodzenie', '#6aa84f', NULL),
(2, 1, 'Niepowodzenie', '#cc0000', NULL);
...
INSERT INTO `role` (`id`, `project_id`, `name`) VALUES
(1, 1, 'TPLead');
...
--
-- Zrzut danych tabeli `role_settings`
--

INSERT INTO `role_settings` (`id`, `role_id`, `role_action_id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4),
...
(1, 'administrator@testarena.pl', '', 'ce89ce028683084df2c39f9510fb045259c4a552', '1c3604332c047145', 0, 2, '2012-10-02 14:30:00', '2025-01-23 14:01:58', NULL, 'TestArena', 'Admin', 1, 'TestArena', 'IT', '', 1, 'pl_PL');
...
INSERT INTO `version` (`id`, `project_id`, `name`, `description`) VALUES
(1, 1, 'TP_V0.01', '');
